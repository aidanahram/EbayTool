...
abstract class ReactiveWidgetInterface<T extends ChangeNotifier>
  ...
  void didUpdateWidget(
      covariant ReactiveWidgetInterface<T> oldWidget, T model) {}
}

/// A widget that listens to a [ChangeNotifier] and rebuilds when the model updates.
abstract class ReactiveWidget<T extends ChangeNotifier>
    extends ReactiveWidgetInterface<T> {
  /// A const constructor.
...
abstract class ReusableReactiveWidget<T extends ChangeNotifier>
    extends ReactiveWidgetInterface<T> {
  /// The model to borrow.
  final T model;
...
class ReactiveWidgetState<T extends ChangeNotifier>
    extends State<ReactiveWidgetInterface<T>> {
